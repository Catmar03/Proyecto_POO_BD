 ...
 * @author antho
 */
public class crud_avion extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField1.setText("Ingrese codigo de id");

        jTextField2.setText("Jngrese aerlinea");

        jTextField3.setText("Fabricante");

        jTextField4.setText("Capacidad");

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "LLeno", "Faltan pasajeros" }));
